    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('VIDEO', 'Video'), ('PHOTO', 'Photo')], default='VIDEO', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playlist', models.IntegerField(blank=True, default=0, help_text='This field is auto-filled with the number of related Campaigns', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.CharField(choices=[('FAMILY', 'Family'), ('FEMALE', 'Female'), ('MALE', 'Male')], default='FAMILY', max_length=25)),
                ('name', models.CharField(max_length=100)),
